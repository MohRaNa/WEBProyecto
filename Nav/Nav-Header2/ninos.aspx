    ...
    <main>
      ...
      <section class="destacados">
        ...
        <ul>
            ...
            <% 
        string sql = "SELECT p.[name],p.[description],p.size,p.cost,p.color,p.stock FROM [dbWeb].[dbo].[Product] AS p INNER JOIN [dbWeb].[dbo].[Categories] AS c ON c.idCategories = p.idCategory WHERE [idCategory] = 3 ";
